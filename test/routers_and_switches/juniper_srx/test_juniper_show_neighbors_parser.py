...
from network_insight_sdk_generic_datasources.routers_and_switches.juniper_srx.juniper_srx_pre_post_processor import \
    JuniperNeighborsTableParser


class JuniperNeighborsTableParserTestCase(unittest.TestCase):
    def test_post_process(self):
        ...
        expected_output = [
            {'localInterface': 'ge-9/0/5', 'remoteInterface': 'ge-0/0/5', 'remoteDevice': 'sw1.rdm.nl.rgtn.com'},
