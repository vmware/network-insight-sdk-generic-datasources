        ...
        for block in blocks:
            ...
            for block_1 in blocks_1:
                ...
                output_line = "{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n".format(output_interface_name, administrative_status,
                                                                  ...
                                                                  output_hardware_address, output_mtu, vlan, connected)
...
class JuniperRouterInterfacePrePostProcessor(PrePostProcessor):
    ...
    def pre_process(self, data):
        output_lines = []
        skip_interface_names= [".local.", ".local..0", ".local..1",".local..2", "fab0.0", "fab1.0", "fxp1.0", "fxp2.0", "lo0.16384",
                               "lo0.16385"]
        parser = LineBasedBlockParser('Physical interface:')
        blocks = parser.parse(data)
        for block in blocks:
            ...
            for block_1 in blocks_1:
                ...
                output_interface_name = "name: {}".format(name)
                output_operational_status = "operationalStatus: {}".format(ops_status)
                output_hardware_address = "hardwareAddress: {}".format("" if hardware_address.isalpha() else hardware_address)
                output_mtu = "mtu: {}".format(mtu if mtu.isdigit() else 0)
                ...
                output_line = "{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n".format(output_interface_name, administrative_status,
                                                                  switch_port_mode, output_operational_status,
                                                                  output_hardware_address, output_mtu, vlan, connected, output_ip_address)
                output_lines.append(output_line)
        return '\n'.join(output_lines)
            ...
            for block_1 in blocks_1:
                ...
                for idx, line_block in enumerate(line_blocks):
                    ...
                    if 'interface' in output[0].keys():
                        ...
                        continue
                    name = "name: {}".format(network_name + "_" + "{}".format(idx))
                    output_route_type = "routeType: {}".format(output[0]['route_type'])
                    output_next_hop = "nextHop: {}".format(output[0]['next_hop'] if "next_hop" in output[0].keys() else "DIRECT")
