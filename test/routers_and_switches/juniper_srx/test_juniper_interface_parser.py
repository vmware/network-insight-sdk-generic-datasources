import unittest
from network_insight_sdk_generic_datasources.routers_and_switches.juniper_srx.juniper_srx_pre_post_processor import JuniperInterfaceParser
...
class JuniperInterfaceParserTestCase(unittest.TestCase):
    def test_post_process(self):
        ...
        expected_output = [{'name': 'reth0  ', 'administrativeStatus': 'UP', 'mtu': '1518', 'operationalStatus': 'UP',
                           ...
                           {'name': 'reth0.50', 'administrativeStatus': 'UP', 'mtu': '1518', 'operationalStatus': 'UP',
                            'connected': 'TRUE', 'members': 'ge-0/0/4.50,ge-0/0/5.50,ge-9/0/4.50,ge-9/0/5.50',
                            'hardwareAddress': '00:10:db:ff:8c:00', 'ipAddress': '10.194.0.1/24'}]
